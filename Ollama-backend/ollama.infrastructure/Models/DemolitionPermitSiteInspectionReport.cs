...
public partial class DemolitionPermitSiteInspectionReport
{
    public int DemolitionPermitSiteInspectionReportId { get; set; }
    ...
    public string? SiteUnderConsideration { get; set; }

    public string? NoExistingBuildings { get; set; }

    public string? HighDevelopmentNearSite { get; set; }

    public string? HighDevelopmentFloors { get; set; }
