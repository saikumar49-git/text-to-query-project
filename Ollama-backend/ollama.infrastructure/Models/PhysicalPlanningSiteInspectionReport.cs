...
public partial class PhysicalPlanningSiteInspectionReport
{
    public int PhysicalPlanningSiteInspectionReportId { get; set; }
    ...
    public int? AdjacentPlots { get; set; }
    ...
    public string? DateOfSubmittion { get; set; }

    public virtual PlanningPermitApplicationFormType? AdjacentPlotsNavigation { get; set; }
}
