...
public partial class PlanningPermitPropertyTitleType
{
    ...
    public virtual ICollection<PpfullOrProvisionalPermitType> PpfullOrProvisionalPermitTypes { get; set; } = new List<PpfullOrProvisionalPermitType>();
