...
public partial class RemodelingElectricalVettingFormDetail
{
    public int RemodelingElectricalVettingFormDetailId { get; set; }
    ...
    public virtual RemodelingPermitApplicationDetail? RemodelingPermitApplicationDetail { get; set; }
}
